# ==========================================================
# File: xgboost_model_v7_softmono.py
# Purpose: Fix price–sales direction without monotone constraints
# ==========================================================
...
if __name__ == "__main__":
    ...
    save_path = Path("xgboost_model_v7_softmono.pkl")
    ...
    fig = px.bar(
        ...
        orientation="h", title="Feature Importance (v7 softmono)",
